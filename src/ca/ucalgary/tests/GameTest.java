...
public class GameTest {
     ...
     */
    @Test
    public void test_TextCollisionsEnemyPlayer() {
     ...
     */
    @Test
    public void test_TextCollisionsProjectilePlayer() {
        Player player = new Player(0, 0, 5);
     ...
     */
    @Test
    public void test_TextThreeCollisionsHealthPlayerEnemy() {
        Player player = new Player(0, 0, 5);
        ArrayList<Enemy> enemies = new ArrayList<Enemy>(Arrays.asList(new Enemy(1,1)));
        ArrayList<Projectile> projectiles = new ArrayList<Projectile>(Arrays.asList(new EnemyProjectile(0,0)));
     ...
     */
    @Test
    public void test_TextThreeCollisionsMoneyPlayerEnemy() {
        Player player = new Player(0, 0, 5);
        ArrayList<Enemy> enemies = new ArrayList<Enemy>(Arrays.asList(new Enemy(1,1)));
        ArrayList<Projectile> projectiles = new ArrayList<Projectile>(Arrays.asList(new EnemyProjectile(0,0)));
     ...
     */
    @Test
    public void test_TextCollisionsProjectileEnemy() {
     ...
     */
    @Test
    public void test_text_basicMovement() {
        Player player = new Player(1, 1, 5);
        ArrayList<Enemy> enemies = new ArrayList<Enemy>(Arrays.asList(new Enemy(0,0)));
     ...
     */
    @Test
    public void test_text_noProjectileAdded() {
        Player player = new Player(1, 1, 5);
